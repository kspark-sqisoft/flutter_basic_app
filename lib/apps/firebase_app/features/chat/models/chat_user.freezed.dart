...
class _$ChatUserImpl implements _ChatUser {
  ...
  @override
  String toString() {
    return 'ChatUser(image: $image, about: $about, name: $name, createdAt: $createdAt, lastActive: $lastActive, id: $id, isOnline: $isOnline, email: $email, pushToken: $pushToken)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, image, about, name, createdAt,
      lastActive, id, isOnline, email, pushToken);
...
abstract class _ChatUser implements ChatUser {
  factory _ChatUser(
      ...
      final String? email,
      @JsonKey(name: 'push_token') final String? pushToken}) = _$ChatUserImpl;
