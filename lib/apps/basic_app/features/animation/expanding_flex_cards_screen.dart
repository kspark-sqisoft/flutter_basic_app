...
class ExpandingFlexCardsScreen extends StatefulWidget {
  const ExpandingFlexCardsScreen({super.key});

  @override
  State<ExpandingFlexCardsScreen> createState() =>
      _ExpandingFlexCardsScreenState();
}

class _ExpandingFlexCardsScreenState extends State<ExpandingFlexCardsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('ExpandingFlexCards')),
      body: Stack(children: [
        Center(
          child: FittedBox(
            fit: BoxFit.fitWidth,
