...
class _CameraScreenState extends State<CameraScreen> {
  ...
  StreamSubscription<DeviceOrientationChangedEvent>?
      _deviceOrientationChangedStreamSubscription;
  ...
  void dispose() {
    ...
    _deviceOrientationChangedStreamSubscription?.cancel();
    _deviceOrientationChangedStreamSubscription = null;
  ...
  Future<void> _initializeCamera() async {
    ...
    try {
      ...
      log('camera.lensDirection:${camera.lensDirection}');
      log('camera.sensorOrientation:${camera.sensorOrientation}');
      log('_resolutionPreset:$_resolutionPreset');
      ...
      unawaited(_deviceOrientationChangedStreamSubscription?.cancel());
      _deviceOrientationChangedStreamSubscription = CameraPlatform.instance
          .onDeviceOrientationChanged()
          .listen(_onDeviceOrientationChanged);
      ...
      log('event.cameraId:${event.cameraId}');
      log('event.previewWidth:${event.previewWidth}');
      log('event.previewHeight:${event.previewHeight}');
      log('event.exposureMode:${event.exposureMode}');
      log('event.exposurePointSupported:${event.exposurePointSupported}');
      log('event.focusMode:${event.focusMode}');
      log('event.focusPointSupported:${event.focusPointSupported}');
      _previewSize = Size(
        event.previewWidth,
        event.previewHeight,
      );
  ...
  Future<void> _onResolutionChange(ResolutionPreset newValue) async {
    log('_onResolutionChange:$newValue');
    setState(() {
  ...
  void _onDeviceOrientationChanged(DeviceOrientationChangedEvent event) {
    log('_onDeviceOrientationChanged:${event.orientation}');
  }

  void _onCameraClosing(CameraClosingEvent event) {
    log('_onCameraClosing:$event');
    if (mounted) {
